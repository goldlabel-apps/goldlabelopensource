...
export default function Icon({icon, color}: IconShape) {
  ...
  switch (icon) {
    ...
    case "forget":
      ...
      break
    case "demo":
      iconFragment = <DemoIcon color={color} />
      break
    case "link":
    ...
    case "forms":
      ...
      break
    case "theme":
      iconFragment = <ThemeIcon color={color} />
      break
    default:
